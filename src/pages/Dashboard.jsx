...
//modification of the dashboard page to and design elements as per the latest requirements. This includes a more dynamic course filtering system, enhanced user profile section, and updated statistics cards to reflect the user's progress and achievements more accurately. The layout has been adjusted to ensure a more intuitive navigation experience while maintaining a visually appealing interface that aligns with the overall branding of the platform.
const Dashboard = () => {
